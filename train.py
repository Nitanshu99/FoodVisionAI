...
# --- 🚫 BLACKLIST: Add folders here to skip them ---
...
def main():
    ...
    if AUTO_CONFIG and AUTO_CONFIG['TRAIN_PRECISION'] == 'fp16':
        print(f"\n⚡ Mixed Precision available but disabled for TensorFlow compatibility")
