...
class NutrientEngine:
    ...
    def _load_database(self) -> None:
        ...
        """
        # Paths
        serving_path = paths.PARQUET_DB_DIR / paths.DB_FILES["serving_size"]
        nutrition_path = paths.PARQUET_DB_DIR / paths.DB_FILES["nutrition"]
        units_path = paths.PARQUET_DB_DIR / paths.DB_FILES["units"]
        links_path = paths.PARQUET_DB_DIR / paths.DB_FILES["links"]
        recipes_path = paths.PARQUET_DB_DIR / paths.DB_FILES["recipes"]
        names_path = paths.PARQUET_DB_DIR / "recipes_names.parquet"
    ...
    def calculate_nutrition(
        ...
        Args:
            class_id (str): Food code identifier
            visual_stats (Dict[str, Any]): Visual statistics from segmentation
                - area_cm2: Area in square centimeters
                - occupancy_ratio: Fill ratio for containers

        Returns:
            Dict[str, Union[str, float, List[str]]]: Complete nutritional profile
        """
